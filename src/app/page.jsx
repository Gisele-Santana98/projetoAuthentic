...
export default function LandingPage() {
  return (
    /* Removido o bg-[#070507] daqui pois já está no Layout, evitando duplicidade */
    <div className="w-full min-h-screen text-white font-sans flex flex-col items-center">
      
      {/* HEADER - Centralização Garantida */}
      ...
      {/* CONTEÚDO PRINCIPAL - Flex Col + Items Center força tudo ao meio */}
      <main className="w-full max-w-[1200px] px-6 py-10 sm:py-16 flex flex-col items-center text-center">
        ...
        {/* Título com largura máxima para não espalhar demais em telas ultra-wide */}
        <h2 className="text-4xl sm:text-6xl lg:text-7xl font-black leading-[1.0] tracking-tighter uppercase mb-10 max-w-[900px]">
          Descubra a <br />
          <span className="text-[#F5BAAF] italic">Autenticação Digital.</span>
        </h2>

        <p className="text-[#888] text-base sm:text-lg max-w-[650px] mb-12 leading-relaxed">
        ...
        {/* GRID DE CARDS - Centralizado no pai */}
        ...
        {/* SEÇÃO SOBRE - Centralização de parágrafo */}
        <section id="sobre" className="py-24 sm:py-32 w-full flex flex-col items-center">
          <h2 className="text-[#DF6E94] text-xl sm:text-2xl font-black uppercase tracking-[0.2em] mb-8 text-center">Sobre</h2>
          <p className="max-w-[850px] text-center text-base sm:text-xl leading-relaxed text-white/60 px-4">
        ...
        {/* SEÇÃO TECNOLOGIA */}
        <section id="tecnologia" className="w-full py-16 px-6 sm:px-12 max-w-[1000px] bg-white/[0.02] border border-white/[0.05] rounded-[40px] text-center sm:text-left flex flex-col sm:flex-row gap-8 items-center">
      ...
      {/* Footer simples removido pois o layout.js já tem um footer completo */}
      <div className="py-12 opacity-10 text-[9px] uppercase tracking-[0.3em]">
